...
function displayCart() {
  ...
  const cartItemList = cartItems.map(function (item, index) {
    const { title, price, image } = item;
    const cartItem = ` <div class="cart-item">
                        <div class="product-icon">
                            <img src="${image}" alt="white t-shirt">
                        </div>
                        <p class="detail">${title}</p>
                        <p class="price">£ ${price}</p>
                        <i class="fa fa-trash-o" aria-hidden="true" onclick="removefromcart(${index})"></i>
                    </div>`;

    return cartItem;
  });
  document.getElementById("cart-items").innerHTML = cartItemList.join("");
